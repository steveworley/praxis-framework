...
import { declineProposedVerb, TriageNotFoundError, TriageValidationError } from '@/lib/triage';
...
export const POST: APIRoute = async ({ params, request }) => {
  ...
  try {
    const detail = await declineProposedVerb(getRoleHome(), slug, parsed.data.reason);
